/**
 * Simple Integration Script for Global Floating Widget
 * Add this to your Nextcloud installation to get the widget on ALL pages
 */
...
(function() {
    ...
    if (window.globalFloatingWidgetInitialized) {
        return;
    }
    window.globalFloatingWidgetInitialized = true;

    // Wait for DOM to be ready
    function initWidget() {
        // Create the floating widget
        createFloatingWidget();
        console.log('✅ Global Floating Widget initialized successfully!');
    }

    function createFloatingWidget() {
        // Create floating button
        const button = document.createElement('div');
        button.id = 'nextcloud-floating-widget';
        button.innerHTML = `
        ...
        panel.innerHTML = `
            ...
            <div class="widget-input-area">
                <div class="widget-input-container">
                    <input type="text" class="widget-message-input" placeholder="Ask NextBot anything..." id="widget-message-input">
                    <button class="widget-send-btn" id="widget-send-btn">📤</button>
                </div>
                <div class="widget-suggestions">
                    <span class="widget-suggestion" onclick="sendSuggestion('Create a group')">Create a group</span>
                    <span class="widget-suggestion" onclick="sendSuggestion('Add users')">Add users</span>
                    <span class="widget-suggestion" onclick="sendSuggestion('How to call?')">How to call?</span>
                    <span class="widget-suggestion" onclick="sendSuggestion('Show features')">Show features</span>
                </div>
            </div>
        `;
        ...
        panel.querySelector('#widget-send-btn').addEventListener('click', sendMessage);
        panel.querySelector('#widget-message-input').addEventListener('keypress', function(e) {
            if (e.key === 'Enter') {
                sendMessage();
            }
        });
    ...
    function addWidgetStyles() {
        if (document.getElementById('nextcloud-widget-styles')) return;
        
        const styles = document.createElement('style');
        styles.id = 'nextcloud-widget-styles';
        styles.textContent = `
            #nextcloud-floating-widget:hover {
                transform: scale(1.1);
