/**
 * Global Smart Talk Widget Injector
 * This script injects the Smart Talk widget on all Nextcloud pages
 */
...
(function() {
    ...
    console.log('Injecting Global Smart Talk Widget...');
    
    // Wait for DOM to be ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', injectSmartTalk);
    } else {
        injectSmartTalk();
    }
    
    function injectSmartTalk() {
    ...
    function initializeGlobalWidget() {
        ...
        console.log('Global Smart Talk Widget injected successfully!');
    }
})();
