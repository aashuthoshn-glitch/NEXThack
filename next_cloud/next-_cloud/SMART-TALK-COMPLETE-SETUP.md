# 🚀 Smart Talk - Complete Setup Guide

## ✅ **SERVER STATUS & LINKS**

### **🌐 Main Access URLs:**
- **Nextcloud Dashboard**: `http://localhost:8080`
- **Smart Talk Widget**: Available on all pages after activation
- **API Endpoints**: `http://localhost:8080/index.php/apps/dashboardtalk/api/`

### **👥 Login Credentials:**
- **Username**: `admin` | **Password**: `MyNextCloud2024!@#$%^`
- **Username**: `aashu` | **Password**: `AashuNextCloud2024!@#$%^`
- **Username**: `adithya` | **Password**: `AdithyaNextCloud2024!@#$%^`
- **Username**: `dhanush` | **Password**: `DhanushNextCloud2024!@#$%^`
...
cd C:\Users\aashu\OneDrive\Desktop\NC.A\nextwaste\next_cloud\next-_cloud
...
### **Step 2: Activate Smart Talk Widget**

#### **Method A: Browser Console Injection (Recommended)**
...
```javascript
// Smart Talk Global Widget v2 - Complete API Integration
(function() {
    'use strict';
    
    if (window.smartTalkGlobalV2Loaded) {
        console.log('Smart Talk already loaded');
        return;
    }
            ...
            <div class="smart-talk-floating-widget-v2" id="smart-talk-floating-v2">
                <div class="floating-header-v2">
                    <div class="floating-title-v2">
                        ...
                        <span class="title-text-v2">Smart Talk v2</span>
...
6. **Press Enter** - The floating chat widget will appear!

#### **Method B: Direct File Access**
1. Open `http://localhost:8080/custom_apps/dashboardtalk/js/global-smart-talk-v2.js`
...
### **✅ Core Features:**
- **🤖 AI Chatbot** - Intelligent responses with context awareness
- **👥 Group Management** - Create and manage chat groups
- **📞 Video/Audio Calls** - Start conversations with team members
- **🔄 Real-time Status** - See online/offline indicators
- **😊 Message Reactions** - React to messages with emojis
- **📱 Mobile Responsive** - Works on all screen sizes

### **✅ Technical Features:**
- **Real API Integration** - Backend database storage
- **Message Persistence** - Messages saved and retrieved
...
### **Chat API:**
- **Send Message**: `POST /index.php/apps/dashboardtalk/api/smart-talk/send`
- **Get Messages**: `GET /index.php/apps/dashboardtalk/api/smart-talk/messages`
- **Create Group**: `POST /index.php/apps/dashboardtalk/api/smart-talk/groups`
- **Get Groups**: `GET /index.php/apps/dashboardtalk/api/smart-talk/groups`

### **Database Tables:**
- **smart_talk_messages** - Stores all chat messages
- **smart_talk_groups** - Stores group information
...
- ✅ Green status indicator in widget header
