<?php
/**
 * Global Smart Talk Widget Injection
 * This template injects the Smart Talk widget on all pages
 */
?>

<script>
// Smart Talk Global Widget - Injected on all pages
(function() {
    'use strict';
    
    // Prevent multiple initializations
    if (window.smartTalkGlobalInitialized) {
        return;
    }
    window.smartTalkGlobalInitialized = true;
